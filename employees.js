...
//CODE HERE
class Employee {
    constructer(name, shifts) {
        this.name = name;
        this.shifts = shifts;
    }
    getSchedule() {
        console.log(`${this.name} works on ${this.shifts.join(' & ')}`);
    }
}
...
//CODE HERE
const empOne = new Employee('Jess', 'weekday mornings, weekday afternooons')
/*
...
class Manager extends Employee {
    constructer(name, shifts, employees) {
        super(name, shifts)
...
//CODE HERE
const manager = new Manager('Winston', empOne.shifts, ['cece', 'schmidt'])
